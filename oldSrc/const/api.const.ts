...
export class API {
    ...
    static api = {
        ...
        "PreviousPost": {
            "prod": (date) => `http://server.caols.tech:9999/api/blog/post/previous/${date}`,
            "dev": (date) => `http://localhost:9999/api/blog/post/previous/${date}`
        },
        "NextPost": {
            "prod": (date) => `http://server.caols.tech:9999/api/blog/post/next/${date}`,
            "dev": (date) => `http://localhost:9999/api/blog/post/next/${date}`
        },
        "Top5Posts": {
